        ...
        <div class="container-fluid fixed-top">
            ...
            <div class="container px-0">
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    <a href="index.html" class="navbar-brand"><h1 class="text-primary display-6">Sate Kyite Wal</h1></a>
                    <button class="navbar-toggler py-2 px-3" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
                        <span class="fa fa-bars text-primary"></span>
                    </button>
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            {{-- Request::route()->getName() so tr current route name ko shar tr --}}
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                        ...
                                        <span class="dropdown-item" data-toggle="modal" data-target="#logoutModal">
                                            <form action="{{route('logout')}}" method="post">
                                                @csrf
                                                <button type="submit" class="btn border-none text-white rounded shadow-sm" style="background-color: #81C408">
